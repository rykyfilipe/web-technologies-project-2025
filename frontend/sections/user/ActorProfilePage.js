...
const ActorProfilePage = (container, info) => {
	...
	actorDataDiv.appendChild(biographyDiv);
	//actorDataDiv.appendChild(biographyP);

	const known_forH = document.createElement("h2");
	known_forH.textContent = "Known for";
	known_forH.classList.add("known-for-h");
	...
	actorPage.appendChild(known_forH);
